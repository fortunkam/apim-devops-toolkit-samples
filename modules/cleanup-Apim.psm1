function Reset-APIM {
    ...
    Write-Host "Removing KeyVault Named Values"
    $keyVaultNamedValues | ForEach-Object { Remove-AzApiManagementNamedValue -Context $apimContext -NamedValueId $_ }
}

Export-ModuleMember -Function Reset-APIM